...
<?php if(have_posts()) : ?><?php while(have_posts()) : the_post(); ?>
		...
		?>
				<article class="pt2 pb2 post_archive" id="post-<?php the_ID(); ?>">
					...
					<p class="mb0 smaller categories_et_tags"><span class="categories"><?php echo get_category_parents($categorie[0]->term_id,'true','');?></span> <span class="tags"><?php echo $liste_tags; /*the_tags( '', ', ','' );*/?></span></p>
