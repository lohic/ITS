<!-- FOOTER -->
        ...
        <footer class="row pt2 pb2">
        	...
        	<div>
                <a href="<?php bloginfo('rss2_url'); ?>" id="rss" title="ITS RSS" target="_blank">
                    <img src="<?php bloginfo( 'template_url' ); ?>/img/icn_rss.png" alt="RSS"/>
                </a>
	        	<a href="<?php the_field('url_facebook', 'option'); ?>" id="facebook" title="facebook" target="_blank">
                    <img src="<?php bloginfo( 'template_url' ); ?>/img/icn_facebook.png" alt="facebook"/>
                </a>
	        	<a href="<?php the_field('url_twitter', 'option'); ?>" id="twitter" title="twitter" target="_blank">
