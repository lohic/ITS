	...
	<fieldset class="clearfix frm_style_roller">		    
		...
		<div class="widget clearfix">
			...
			<div class="widget-inside">
				<div class="field-group clearfix" style="padding-right:0;width:100%;">
					...
					<input type="text" name="frm_font" id="frm_font" value="<?php echo esc_attr($frmpro_settings->font) ?>"  class="frm_full_width" />
				</div>
		...
		<div class="widget clearfix">
			...
			<div class="widget-inside">
				<div class="field-group clearfix" style="padding-right:0;width:100%;">
					<label><?php _e('Family', 'formidable') ?></label>
					<input type="text" name="frm_description_font" id="frm_description_font" value="<?php echo esc_attr($frmpro_settings->description_font) ?>"  class="frm_full_width" />
				</div>
				<div class="field-group field-group-background clearfix">
					<label><?php _e('Color', 'formidable') ?></label>
		...
		<div class="widget clearfix global-font">
			...
			<div class="widget-inside" style="padding-top:10px;">
    				...
    				<div class="field-group clearfix">
    					<label><?php _e('Family', 'formidable') ?></label>
    					<input type="text" name="frm_check_font" id="frm_check_font" value="<?php echo esc_attr($frmpro_settings->check_font) ?>"  class="frm_full_width" />
    				</div>
    				<div class="field-group field-group-background clearfix">
    					<label><?php _e('Color', 'formidable') ?></label>
		...
		<div class="widget clearfix">
			<div class="widget-top">
				<div class="widget-title-action"><a class="widget-action"></a></div>
				<div class="widget-title"><h4><?php _e('Custom CSS', 'formidable') ?></h4></div>
			</div>
			<div class="widget-inside">
                <textarea name="frm_custom_css" style="width:100%;height:150px;margin:5px 0;"><?php echo FrmAppHelper::esc_textarea($frmpro_settings->custom_css) ?></textarea>
