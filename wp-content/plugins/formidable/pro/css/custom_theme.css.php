...
.with_frm_style label.frm_primary_label, .with_frm_style.frm_login_form label{font-family:<?php echo stripslashes($font) ?>;font-size:<?php echo $font_size ?>;color:#<?php echo $label_color ?>;font-weight:<?php echo $weight ?>;text-align:<?php echo $align ?>;margin:0;padding:0;width:auto;display:block;}
...
.with_frm_style .frm_scale label{font-weight:<?php echo $check_weight ?>;}
...
.with_frm_style input[type=text], .with_frm_style input[type=password], .with_frm_style input[type=email], .with_frm_style input[type=number], .with_frm_style input[type=url], .with_frm_style input[type=tel], .with_frm_style input[type=file], .with_frm_style select {height:<?php echo ($field_height == '') ? 'auto' : $field_height ?>;line-height:<?php echo $line_height ?>;}
.with_frm_style select[multiple="multiple"]{height:auto;line-height:normal;}
.with_frm_style input[type=file]{color:#<?php echo $text_color ?>;border:none;padding:0px;}
.with_frm_style .frm_default, .with_frm_style .placeholder, .with_frm_style .chzn-container-multi .chzn-choices .search-field .default, .with_frm_style .chzn-container-single .chzn-default{color:#<?php echo $text_color ?>;font-style:italic;}
...
.with_frm_style .frm_error_style{background-color:#<?php echo $error_bg ?>;border:1px solid #<?php echo $error_border ?>;color:#<?php echo $error_text ?>;font-size:<?php echo $error_font_size ?>;margin:0;margin-bottom:<?php echo $field_margin ?>;}
...
.with_frm_style .frm_message{margin:5px 0 15px;font-size:<?php echo $success_font_size ?>;}
